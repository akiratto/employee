...
//                .peek(nameAndValue -> System.out.println(nameAndValue._1 + " " + nameAndValue._2 + " "  + nameAndValue._2.getClass()))
                          ...
                          JPQLOrderBy orderBy) 
    {
        ...
        jpqlWords.add(constructJPQLFrom(entityClazz));
        jpqlWords.add(constructJPQLWhere(condition, entityClazz));
        jpqlWords.add(constructJPQLOrderBy(condition, orderBy));
    ...
    private String constructJPQLFrom(Class<E> entityClazz)
    {
        return "FROM " + entityName(entityClazz) + " t";
    }
    ...
    private String constructJPQLWhere(E condition, Class<E> entityClazz) 
    {
