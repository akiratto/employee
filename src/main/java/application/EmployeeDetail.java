...
public class EmployeeDetail implements Serializable {
    ...
    public void initQueryParameters()
    {
        ...
        switch(this.mode) {
            case New:
                entity = new TableEmployee();
                break;
            case Edit:
            case Read:
                if(employeeId == null || employeeId.equals("")) break;
                    
                entity = em.find(TableEmployee.class, employeeId);
    ...
    public TableEmployee getEntity() {
        return entity;
    }
   ...
   public String delete()
   {
       ...
       TableEmployee employee = em.find(TableEmployee.class, this.employeeId);
       if(employee == null) {
